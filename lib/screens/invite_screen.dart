...
class InviteScreen extends StatefulWidget {
  // ✅ HomeShell/BottomNav tab switch साठी callback (existing)
  final ValueChanged<int>? onTab;

  // ✅ “Post” tab action (optional) (existing)
  final VoidCallback? onCreatePost;

  // ✅ NEW: Back arrow -> Feed (smooth IndexedStack switch)
...
class _InviteScreenState extends State<InviteScreen> {
  ...
  Future<void> _sendInvite(Map<String, String> contact) async {
    ...
    final msg =
        res['message'] ?? (res['success'] == true ? 'Invite sent' : 'Failed to send invite');
  ...
  void _handleBack() {
    // ✅ Smooth: IndexedStack tab switch to Feed (no rebuild / no flip)
    if (widget.onBackToFeed != null) {
      widget.onBackToFeed!();
      return;
    }

    // ✅ Fallback (if this screen is opened via Navigator.push somewhere)
          ...
          child: Row(
            children: [
              CircleAvatar(
                ...
                child: Icon(Icons.person_add_alt_1, color: Colors.white, size: 22),
              ),
              SizedBox(width: 10),
              Text(
        ...
        child: Center(
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                const Padding(
                  padding: EdgeInsets.only(left: 20, right: 20, top: 6, bottom: 8),
                  child: Text(
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      isDense: true,
                      prefixIcon: const Icon(Icons.search, color: accent, size: 20),
                                  ...
                                  child: ListTile(
                                    ...
                                    trailing: SizedBox(
                                      ...
                                      child: ElevatedButton(
                                        ...
                                        onPressed: isSending ? null : () => _sendInvite(contact),
                                        child: isSending
                                            ? const SizedBox(
                                                width: 16,
                                                height: 16,
